 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "aicortex-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "aicortex-static.copilothub.ai")
 */
