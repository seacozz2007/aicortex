...
const AGENT_STORAGE_KEY = "aicortex:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "aicortex:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "aicortex:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "aicortex:chat:width";
const CHAT_HEIGHT_KEY = "aicortex:chat:height";
const CHAT_EXPANDED_KEY = "aicortex:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "aicortex:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "aicortex:chat:isOpen";
