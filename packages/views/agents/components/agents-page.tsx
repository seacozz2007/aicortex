...
import type { Agent, AgentRuntime, CreateAgentRequest } from "@aicortex/core/types";
import {
...
import { useAgentsViewStore } from "@aicortex/core/agents/stores";
...
import { DataTable } from "@aicortex/ui/components/ui/data-table";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          {t(($) => $.page.tagline)}{" "}
          <a
            href="https://aicortex.ai/docs/agents"
            target="_blank"
