...
describe("LoginPage", () => {
  ...
  it("renders email form with 'Sign in to AICortex' title", () => {
    renderWithI18n(<LoginPage onSuccess={onSuccess} />);
    expect(
      screen.getByText(/sign in to aicortex/i),
    ).toBeInTheDocument();
    expect(
  ...
  it("shows cli_confirm step when existing session + cliCallback", async () => {
    localStorage.setItem("aicortex_token", "existing-jwt");
