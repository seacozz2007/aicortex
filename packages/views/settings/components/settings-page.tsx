...
import { EndUserSettingsTab } from "../../enduser";
...
const WORKSPACE_TAB_KEYS = ["general", "repositories", "integrations", "labs", "members", "enduser"] as const;
    ...
    >
      ...
      <div className="flex-1 min-w-0 md:overflow-y-auto">
        <div className="w-full max-w-3xl mx-auto p-4 md:p-6">
          ...
          <TabsContent value="enduser"><EndUserSettingsTab /></TabsContent>
          {extraAccountTabs?.map((tab) => (
