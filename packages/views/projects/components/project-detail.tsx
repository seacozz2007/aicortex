...
import type { Issue, IssueAssigneeGroup, ProjectStatus, ProjectPriority, UpdateIssueRequest } from "@aicortex/core/types";
import { useAuthStore } from "@aicortex/core/auth";
import { projectDetailOptions } from "@aicortex/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@aicortex/core/projects/mutations";
import { pinListOptions } from "@aicortex/core/pins";
import { useCreatePin, useDeletePin } from "@aicortex/core/pins";
import { myIssueAssigneeGroupsOptions, myIssueListOptions, childIssueProgressOptions, type AssigneeGroupedIssuesFilter, type MyIssuesFilter } from "@aicortex/core/issues/queries";
...
import { createIssueViewStore } from "@aicortex/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@aicortex/core/issues/stores/view-store-context";
...
import { EmojiPicker } from "@aicortex/ui/components/common/emoji-picker";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "aicortex_project_detail_layout",
  });
