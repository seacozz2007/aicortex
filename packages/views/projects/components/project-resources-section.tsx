...
import { ChevronRight, FolderGit, FolderOpen, Palette, Plus, Trash2 } from "lucide-react";
...
function ResourceRow({
  ...
  if (resource.resource_type === "design_system") {
    const ref = resource.resource_ref as DesignSystemResourceRef;
    return (
      <div className="flex items-center gap-2 text-xs group">
        ...
        <Tooltip>
          <TooltipTrigger
            render={
              <span className="truncate flex-1">{resource.label || ref.name}</span>
            }
          />
