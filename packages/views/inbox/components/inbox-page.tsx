...
import {
  ...
  useInboxUnreadCount,
} from "@aicortex/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useMarkAllInboxRead,
...
} from "@aicortex/core/inbox/mutations";
...
import type { InboxItem } from "@aicortex/core/types";
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      <IssueDetail
        ...
        layoutId="aicortex_inbox_issue_detail_layout"
