...
import { runtimeKeys } from "@aicortex/core/runtimes/queries";
import { useWSEvent } from "@aicortex/core/realtime";
import { paths, useWorkspaceSlug } from "@aicortex/core/paths";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const INSTALL_CMD = "curl -fsSL https://raw.githubusercontent.com/aicortex/aicortex/main/scripts/install.sh | bash";

const CONFIGURE_CMD = `aicortex config set server_url https://api.aicortex.ai
aicortex config set app_url https://aicortex.ai`;

const LOGIN_CMD = "aicortex login --token <YOUR_TOKEN>";

const START_CMD = `aicortex daemon start --device-name "my-ec2-instance"
