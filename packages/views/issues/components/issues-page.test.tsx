...
// Mock @aicortex/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@aicortex/core/issues/stores/view-store-context", () => ({
...
vi.mock("@aicortex/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@aicortex/core/issues/stores/selection-store", () => ({
...
vi.mock("@aicortex/core/issues/stores/recent-issues-store", () => ({
