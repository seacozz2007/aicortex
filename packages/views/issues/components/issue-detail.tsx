...
import { Popover, PopoverTrigger, PopoverContent } from "@aicortex/ui/components/ui/popover";
import { Checkbox } from "@aicortex/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@aicortex/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@aicortex/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { Attachment, Issue, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@aicortex/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@aicortex/core/issues/config";
...
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions, issueAttachmentsOptions } from "@aicortex/core/issues/queries";
import { issueLabelsOptions } from "@aicortex/core/labels";
import { memberListOptions, agentListOptions } from "@aicortex/core/workspace/queries";
import { useRecentIssuesStore } from "@aicortex/core/issues/stores";
import { useIssueSelectionStore } from "@aicortex/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@aicortex/ui/components/common/reaction-bar";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "aicortex_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
  const id = issueId;
  ...
  useEffect(() => {
    ...
    const flagKey = `aicortex_cmdF_warned:${id}`;
