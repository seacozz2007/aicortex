...
export const PROJECT = {
  ...
  description:
    "A few things to try in AICortex. Work through them at your own pace.",
};
...
export function buildWelcomeIssueText(
  ...
  const header = [
    ...
    ``,
    `[Learn how AICortex works →](https://aicortex.ai/docs/how-aicortex-works)`,
    ``,
    `---`,
    ``,
  ].join("\n");
  ...
  const sharedInstructions = [
    ...
    `2. **Explain how we work together in AICortex**:`,
  ...
  switch (q.use_case) {
    case "coding":
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex. They plan to use you mostly for **coding work**.\n\n${sharedInstructions}`,
      };
    case "planning":
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex. They want your help with **planning and breaking down work**.\n\n${sharedInstructions}`,
      };
    case "writing_research":
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex. They'll use you for **research and writing** — drafting, summarizing, analysis.\n\n${sharedInstructions}`,
      };
    case "explore":
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex. They're **exploring** what AICortex can do — no specific goal yet.\n\n${exploreInstructions}`,
      };
    case "other": {
      ...
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex. ${contextLine}\n\n${sharedInstructions}`,
      };
    }
    default:
      return {
        title: "👋 Welcome to AICortex — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using AICortex.\n\n${sharedInstructions}`,
      };
  }
}
...
export function buildAgentGuidedSubIssues(
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        `**Every issue has a right-side panel** called **Properties**. From there you control who works on what. Agents in AICortex are triggered when an issue has:`,
        ``,
        ...
        ``,
        `[Learn about assigning issues →](https://aicortex.ai/docs/assigning-issues)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[Learn about chat →](https://aicortex.ai/docs/chat)`,
      ].join("\n"),
    },
    {
      status: "todo",
      ...
      description: [
        ...
        ``,
        `[Learn about workspaces →](https://aicortex.ai/docs/workspaces)`,
      ].join("\n"),
    },
  ];
  ...
  if (q.team_size === "team") {
    tier2.push({
      ...
      description: [
        `AICortex works best when a small team shares agents.`,
        ``,
        `**Where to find it**:`,
        ...
        ``,
        `[Learn about members and roles →](https://aicortex.ai/docs/members-roles)`,
      ].join("\n"),
    });
  }
  ...
  tier2.push({
    ...
    description: [
      ...
      ``,
      `[Learn about creating agents →](https://aicortex.ai/docs/agents-create)`,
    ].join("\n"),
  });
  ...
  const tier3: ImportStarterIssuePayload[] = [
    ...
    },
    {
      ...
      description: [
        ...
        ``,
        `[Learn about tasks →](https://aicortex.ai/docs/tasks)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[Learn about the inbox →](https://aicortex.ai/docs/inbox)`,
      ].join("\n"),
    },
    {
      status: "backlog",
      ...
      description: [
        ...
        ``,
        `[Learn about autopilots →](https://aicortex.ai/docs/autopilots)`,
      ].join("\n"),
    },
  ];
  ...
  const tier1: ImportStarterIssuePayload[] = [
    {
      ...
      description: [
        ...
        `1. Go to [github.com/aicortex/aicortex/releases/latest](https://github.com/aicortex/aicortex/releases/latest) and download the \`.dmg\` for macOS`,
        ...
        ``,
        `[Learn about runtimes →](https://aicortex.ai/docs/daemon-runtimes)`,
      ].join("\n"),
    },
    {
      status: "todo",
