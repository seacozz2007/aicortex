...
import { isGlobalPath } from "@aicortex/core/paths";
...
/**
 * Open a link — internal paths dispatch aicortex:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("aicortex:navigate", { detail: { path } }),
    );
  } else {
