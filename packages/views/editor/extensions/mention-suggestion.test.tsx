...
import { issueKeys, PAGINATED_STATUSES } from "@aicortex/core/issues/queries";
import { I18nProvider } from "@aicortex/core/i18n/react";
import type { IssueStatus, ListIssuesCache } from "@aicortex/core/types";
...
vi.mock("@aicortex/core/platform", () => ({
  getCurrentWsId: () => "ws-1",
}));
