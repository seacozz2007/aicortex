...
vi.mock("@aicortex/core/issues/queries", () => ({
...
vi.mock("@aicortex/core/issues/stores/draft-store", () => ({
...
vi.mock("@aicortex/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@aicortex/core/issues/mutations", () => ({
...
vi.mock("@aicortex/ui/components/ui/dialog", () => ({
...
vi.mock("@aicortex/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@aicortex/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@aicortex/ui/components/common/file-upload-button", () => ({
