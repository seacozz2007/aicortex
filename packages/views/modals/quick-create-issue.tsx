...
import { DialogTitle } from "@aicortex/ui/components/ui/dialog";
...
} from "@aicortex/core/issues/stores/quick-create-store";
...
} from "@aicortex/core/runtimes";
import { useFileUpload } from "@aicortex/core/hooks/use-file-upload";
import { formatShortcut, modKey, enterKey } from "@aicortex/core/platform";
...
export function AgentCreatePanel({
  ...
  // bundled aicortex CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
