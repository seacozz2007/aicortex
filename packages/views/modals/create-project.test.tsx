...
const longRepoUrl =
  "https://github.com/aicortex/a-very-long-repository-name-that-needs-a-tooltip";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@aicortex/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@aicortex/core/projects", () => ({
...
vi.mock("@aicortex/ui/components/ui/popover", () => ({
...
vi.mock("@aicortex/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
