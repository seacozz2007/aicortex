...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@aicortex/core/types";
import {
  DialogContent,
  DialogTitle,
...
import { useIssueDraftStore } from "@aicortex/core/issues/stores/draft-store";
import { useCreateModeStore } from "@aicortex/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@aicortex/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@aicortex/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@aicortex/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("aicortex:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("aicortex:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
