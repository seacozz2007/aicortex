...
Cohesion: 0.18
Nodes (21): DailyCostChart(), DailyTasksChart(), DailyTasksData, DailyTimeChart(), DailyTimeData, DailyTokensChart(), HourlyActivityChart(), HourlyCostPoint (+13 more)
...
Cohesion: 0.56
Nodes (9): T, applyPoolSizing(), TestPoolSizing_DefaultsWhenNothingSet(), TestPoolSizing_EnvOverridesURL(), TestPoolSizing_InvalidEnvFallsBackToCodeDefault(), TestPoolSizing_InvalidEnvFallsBackToURLParam(), TestPoolSizing_MinClampedToMax(), TestPoolSizing_PartialURLParam() (+1 more)
...
Cohesion: 0.30
Nodes (10): detectGitRepo(), fetchOrigin(), getRemoteDefaultBranch(), removeGitWorktree(), repoNameFromURL(), runGitWorktreeAdd(), sanitizeName(), setupGitWorktree() (+2 more)
...
Cohesion: 0.42
Nodes (8): codexDarwinNetworkAccessFixed(), codexUpgradeHint(), parseCodexSemver(), renderAICortexManagedBlock(), stripLegacySandboxDirectives(), upsertAICortexManagedBlock(), codexSandboxPolicy, codexSemver
...
Cohesion: 0.14
Nodes (21): Context, Queries, TaskService, Context, Duration, Issue, Queries, TaskService (+13 more)
...
Cohesion: 0.16
Nodes (7): ManagedRelay, MirroredRelay, NewMirroredRelay(), Broadcaster, Context, DaemonRuntimeDeliverer, RelayPublisher
