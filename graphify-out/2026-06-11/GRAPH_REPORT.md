...
## Corpus Check
- 2492 files · ~4,095,875 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 39143 nodes · 74937 edges · 2220 communities (2108 shown, 112 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 3552 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c58eb611`
...
## Communities (2220 total, 112 thin omitted)

### Community 0 - "API Error Handling & Client Setup"
Cohesion: 0.05
Nodes (77): agentActivityKeys, agentRunCountsKeys, agentTasksKeys, agentTaskSnapshotKeys, agentTemplateDetailOptions(), agentTemplateKeys, agentTemplateListOptions(), assignedFilter (+69 more)

### Community 1 - "Virtual Office Presence System"
Cohesion: 0.06
Nodes (60): AgentSection(), AutopilotDialogProps, AutopilotInitial, computeNextRun(), DAY_KEYS, formatNextRunAbsolute(), FREQUENCY_KEYS, OUTPUT_MODE_ICONS (+52 more)

### Community 2 - "Desktop App Shell & Window Management"
Cohesion: 0.02
Nodes (270): agentRunCounts30dOptions(), agentTaskSnapshotOptions(), useWorkspacePresenceMap(), WorkspaceAgentAvailability, useWorkspacePresencePrefetch(), ApiError, useAuthStore, LoginPage() (+262 more)

### Community 3 - "API Client & CRUD Operations"
Cohesion: 0.07
Nodes (34): DesignCommentQueuePanel(), QueuedPreviewComment, DesignCommentToolbar(), MODE_TOOLS, ZOOM_STEPS, ColorSwatch(), DesignElementInspector(), DesignViewport (+26 more)

### Community 4 - "Workspace Presence & Agent Detail"
Cohesion: 0.02
Nodes (11): ApiClient, parseWithFallback(), CreateEditChatShareModalProps, ChatSession, ChatShareLink, CreateDesignSessionRequest, DesignExportResponse, DesignParameterDef (+3 more)
...
Cohesion: 0.02
Nodes (178): buildPresenceMap(), deriveAgentAvailability(), deriveAgentPresenceDetail(), DerivePresenceInput, deriveWorkload(), deriveWorkloadDetail(), a, agentA (+170 more)

### Community 7 - "File Upload & Emoji Picker"
Cohesion: 0.02
Nodes (204): ActorIssuesPanel(), ActorIssuesSkeleton(), SCOPE_VALUES, TaskActorType, PropRow(), BatchActionToolbar(), animateLayoutChanges(), BoardCardContent (+196 more)

### Community 8 - "Visibility & Permission Labels"
Cohesion: 0.03
Nodes (126): ChatShareManagementPage(), CreateEditChatShareModal(), logger, useCreateChatShareLink(), useDeleteChatShareLink(), useUpdateChatShareLink(), chatShareKeys, chatShareLinkOptions() (+118 more)

### Community 9 - "Cross-Workspace Test Fixtures"
Cohesion: 0.04
Nodes (150): MenuPrimitives, FileUploadButton(), FileUploadButtonProps, PillButton(), SubmitButton(), AgentOverviewPane(), DetailTab, detailTabs (+142 more)

### Community 10 - "Agent & Autopilot Creation"
Cohesion: 0.24
Nodes (15): AgentTemplateId, recommendTemplate(), ALL_USE_CASES, result, roles, ONBOARDING_STEP_ORDER, completeOnboarding(), joinCloudWaitlist() (+7 more)

### Community 11 - "Issue URL Sync & Reply Input"
Cohesion: 0.09
Nodes (33): ChatStoreInstance, ChatState, ChatStoreOptions, ChatTimelineItem, ContextAnchor, createChatStore(), logger, readDrafts() (+25 more)

### Community 12 - "Agent Presence & Run Counts"
Cohesion: 0.02
Nodes (172): CapabilityBanner(), getCopy(), Reason, Resource, RESOURCE_NOUN, MentionHoverCard(), MentionHoverCardProps, ChatQueueBar() (+164 more)

### Community 13 - "Agent UI Section & Filters"
Cohesion: 0.02
Nodes (235): NotFound(), CliCallbackConfig, GoogleAuthConfig, LoginPageProps, redirectToCliCallback(), EmojiPicker, QUICK_EMOJIS, QuickEmojiPicker() (+227 more)

### Community 14 - "Task Status & Agent Activity"
Cohesion: 0.05
Nodes (96): isPendingTaskInFlight(), mergePendingTaskOnEnqueue(), githubKeys, commentToTimelineEntry(), cacheUpdates, first, handler, queryState (+88 more)

### Community 15 - "Comments & Timeline"
Cohesion: 0.07
Nodes (71): init(), resolveAgent(), runAutopilotCreate(), runAutopilotDelete(), runAutopilotGet(), runAutopilotList(), runAutopilotRuns(), runAutopilotTrigger() (+63 more)

### Community 16 - "Analytics & API Instance"
Cohesion: 0.03
Nodes (149): useAgentPresenceDetail(), useWorkspaceAgentAvailability(), apiErrorStatus(), isChatSessionNotFound(), api, EnsureChatSessionOptions, invalidateStaleChatSession(), useEnsureChatSession() (+141 more)
...
Cohesion: 0.02
Nodes (107): link, makeAgent(), makeTask(), mockAgents, mockIssue, mockPresence, mockSnapshot, renderCard() (+99 more)
...
Cohesion: 0.12
Nodes (79): readFile(), codexSandboxPolicyFor(), Prepare(), ReadGCMeta(), discardLogger(), TestCleanupPreservesLogs(), TestCodexSandboxPolicyFor(), TestEnsureCodexSandboxConfigCreatesDefaultLinux() (+71 more)

### Community 22 - "Onboarding & Starter Content"
Cohesion: 0.08
Nodes (44): VISIBILITY_DESCRIPTION, VISIBILITY_LABEL, VISIBILITY_TOOLTIP, visibilityLabel(), LabelsPanel(), VisibilityBadge(), hybridMatch(), match() (+36 more)
...
Cohesion: 0.05
Nodes (73): blockedArgMode, buildClaudeArgs(), buildClaudeInput(), buildEnv(), detectCLIVersion(), extractVersionLine(), filterCustomArgs(), isFilteredChildEnvKey() (+65 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (141): account, click_avatar_hint, name_label, save, saving, section_profile, toast_avatar_failed, toast_avatar_updated (+133 more)
...
Cohesion: 0.10
Nodes (32): InboxDetailLabel(), shortDate(), useTypeLabels(), escapeRegExp(), getInboxDisplayTitle(), getQuickCreateFailureDetail(), singleLine(), stripQuickCreatePrefix() (+24 more)
...
Cohesion: 0.10
Nodes (66): blockingBackend, NewClient(), mergeUsage(), newWorkspaceState(), createDaemonTestRepo(), newRepoReadyTestDaemon(), newTestDaemon(), TestBuildPromptAutopilotRunOnly() (+58 more)
...
Cohesion: 0.10
Nodes (61): claimRuntimeGuardTask, claimTaskForRuntimeGuard(), createRuntimeGuardAgent(), createRuntimeGuardRuntime(), newDaemonTokenRequest(), setHandlerTestWorkspaceRepos(), setupForeignWorkspaceFixture(), TestCancelTask_CrossWorkspace_Returns404() (+53 more)
...
Cohesion: 0.07
Nodes (32): DesignExamplePreview(), DesignProjectPicker(), CREATE_CHIP_IDS, DesignStudioHub(), INTENT_ICONS, MORE_CHIP_IDS, SUBCATEGORY_ICONS, CatalogItem() (+24 more)
...
Cohesion: 0.05
Nodes (50): resetAnalytics(), ParseOptions, EventHandler, FakeWebSocket, url, ws, WSClient, WSClientIdentity (+42 more)
...
Cohesion: 0.10
Nodes (55): ActiveProfile, bootstrapCli(), bundledCliPath(), clearToken(), configWriteChain, DEFAULT_PREFS, deriveProfileName(), desktopSpawnEnv() (+47 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (48): I18nWrapper(), mockPersist, mockReload, mockToastWarning, mockUpdateMe, TEST_RESOURCES, useAuthStore, user (+40 more)
...
Cohesion: 0.12
Nodes (31): defaultRenderMention(), MarkdownProps, MemoizedMarkdown, configStore, out, parser, CodeBlock(), CodeBlockProps (+23 more)
...
Cohesion: 0.06
Nodes (34): Level, Init(), isTerminal(), NewLogger(), parseLevel(), NewDBCollector(), newDBDesc(), TestDBCollectorExposesPoolStats() (+26 more)
...
Cohesion: 0.12
Nodes (46): inAgentExecutionContext(), init(), newAPIClient(), normalizeAPIBaseURL(), parseCustomArgs(), parseCustomEnv(), requireWorkspaceID(), resolveCustomEnv() (+38 more)

### Community 67 - "Community 67"
Cohesion: 0.12
Nodes (56): assigneeKinds, assigneeMatch, strVal(), issueDisplayKey(), loadActorDisplayLookup(), resolveIssueRef(), activeDuplicateIssueCreateMessage(), ambiguousAssigneeError() (+48 more)
...
Cohesion: 0.07
Nodes (53): CommandHandler, EmailService, Config, dbExecutor, ctxMember(), int8ToPtr(), New(), parseUUID() (+45 more)
...
Cohesion: 0.03
Nodes (63): page, empty, title, remove_label, card, agents_section, detail_link, more_agents_one (+55 more)
...
Cohesion: 0.03
Nodes (85): useCreateAutopilot(), useCreateAutopilotTrigger(), useDeleteAutopilot(), useDeleteAutopilotTrigger(), useTriggerAutopilot(), useUpdateAutopilot(), useUpdateAutopilotTrigger(), Page() (+77 more)
...
Cohesion: 0.16
Nodes (26): IssueActionsContextMenu(), IssueActionsContextMenuProps, IssueActionsDropdown(), IssueActionsDropdownProps, contextPrimitives, dropdownPrimitives, IssueActionsMenuItems(), IssueActionsMenuItemsProps (+18 more)

### Community 80 - "Community 80"
Cohesion: 0.10
Nodes (46): newFlagTestCmd(), newIssueCreateTestCmd(), pipeStdin(), TestActorDisplayLookupLazyLoads(), TestFetchAutopilotCandidatesPaginates(), TestFormatAssignee(), TestIssueSubscriberList(), TestIssueSubscriberMutationBody() (+38 more)
...
Cohesion: 0.09
Nodes (40): AgentSkillSummary, agentToResponse(), canViewAgentEnv(), computeTaskKind(), decodeJSONBodyWithRawFields(), TestComputeTaskKind(), redactEnv(), redactMcpConfig() (+32 more)

### Community 86 - "Community 86"
Cohesion: 0.05
Nodes (39): cli, authorize, authorizing, description, different_account, title, common, back (+31 more)
...
Cohesion: 0.13
Nodes (24): artifactKeys, useRuntimeArtifactSources(), useTaskArtifacts(), ChatArtifactPanel(), isTextArtifact(), TEXT_EXTENSIONS, buildArtifactRawURL(), IMAGE_EXTENSIONS (+16 more)
...
Cohesion: 0.13
Nodes (31): captureDownloadInitiated(), captureDownloadIntent(), captureDownloadPageViewed(), DownloadDetectPayload, DownloadInitiatedPayload, DownloadIntentSource, setPersonPropertiesOnce(), captureFeedbackOpened() (+23 more)
...
Cohesion: 0.07
Nodes (32): Agent, aicortex agent create, Agent Creator, Agent Creation Form, Archive, Autopilot (Routines), Chat, ClawHub (+24 more)
...
Cohesion: 0.18
Nodes (14): ChatTerminalPanel(), pickTerminalSession(), terminalStorageKey(), ExplorePage(), SessionItem(), NewSessionDialog(), NewSessionDialogProps, useCloseTerminalSession() (+6 more)
...
Cohesion: 0.22
Nodes (7): client, entry, fallback, opts, out, schema, stubFetchJson()
...
Cohesion: 0.18
Nodes (22): getCustomPricing(), ARCH_LABEL, canonicalCandidates(), computeCostInWindow(), CostBreakdown, CostByKey, DailyCostData, DailyCostStackData (+14 more)
...
Cohesion: 0.03
Nodes (58): description, title, agents_group, created_by, error_agent_unavailable_fallback, error_daemon_version, error_unknown, no_agents (+50 more)
...
Cohesion: 0.13
Nodes (22): EditorBubbleMenu(), ContentEditorProps, stripBlobUrls(), mockFocus, HoverState, LinkHoverCard(), truncateUrl(), useLinkHover() (+14 more)

### Community 138 - "Community 138"
Cohesion: 0.05
Nodes (35): Agent Assignees, AI Agent Verification Loop, API Response Compatibility, Architecture, Backend Handler UUID Parsing Convention, CI Requirements, CLI Release, Coding Rules (+27 more)
...
Cohesion: 0.13
Nodes (35): CustomPricingDialog(), CostCell(), ChartLegend(), computeTotals(), CostByBlock(), CostByList(), DailyBreakdownTable(), DailyMetric (+27 more)

### Community 147 - "Community 147"
Cohesion: 0.14
Nodes (41): ReportIssueArtifacts(), ScanHTMLArtifacts(), mustWrite(), TestScanHTMLArtifacts(), ScanCandidate, createTaskDir(), newGCTestDaemon(), TestActiveEnvRootRefcount() (+33 more)
...
Cohesion: 0.12
Nodes (21): ThemeProvider(), AccountTab(), LabsTab(), DARK_COLORS, LIGHT_COLORS, PreferencesTab(), WindowMockup(), ACCOUNT_TAB_ICONS (+13 more)
...
Cohesion: 0.14
Nodes (25): AgentCostRow, AgentDashboardRow, aggregateAgentTokens(), aggregateDailyCost(), aggregateDailyTasks(), aggregateDailyTime(), aggregateDailyTokens(), computeDailyTotals() (+17 more)
...
Cohesion: 0.23
Nodes (29): resolveProfile(), buildDaemonStartArgs(), checkDaemonHealthOnPort(), daemonDirForProfile(), daemonLogPathForProfile(), daemonPIDPathForProfile(), emptyDash(), flagString() (+21 more)
...
Cohesion: 0.03
Nodes (87): add_child, description, title, toast_failed, toast_success, backlog_hint, toast_status_failed, common (+79 more)
...
Cohesion: 0.13
Nodes (24): browserTimezone(), COMMON_TIMEZONES, IntlWithSupportedValues, supportedTimezones(), timezoneOptions(), TimezoneSelect(), DailyMetric, DailyTrendBlock() (+16 more)
...
Cohesion: 0.09
Nodes (29): createBlurShortcutExtension(), createFileUploadExtension(), createEditorExtensions(), EditorExtensionsOptions, ImageExtension, LinkExtension, lowlight, createMarkdownCopyExtension() (+21 more)
...
Cohesion: 0.12
Nodes (32): renderAutopilotContext(), renderIssueContext(), renderQuickCreateContext(), resolveSkillsDir(), sanitizeSkillName(), writeContextFiles(), writeProjectResources(), writeSkillFiles() (+24 more)

### Community 229 - "Community 229"
Cohesion: 0.09
Nodes (30): DualWriteBroadcaster, envelope, deliverEnvelope(), envelopeFromXMessage(), envelopeRedisValues(), HeartbeatKey(), injectEventID(), NewDualWriteBroadcaster() (+22 more)
...
Cohesion: 0.27
Nodes (13): buildAutopilotPrompt(), buildChatPrompt(), buildCommentPrompt(), buildQuickCreatePrompt(), TestBuildPromptNonSquadLeaderNoRule(), TestBuildPromptSquadLeaderNoActionForAgentTrigger(), TestBuildPromptSquadLeaderNoActionForMemberTrigger(), TestBuildQuickCreatePromptAssigneeIncludesSquads() (+5 more)
...
Cohesion: 0.13
Nodes (31): GenerateDaemonToken(), GeneratePATToken(), HashToken(), JWTSecret(), randomID(), MapClaims, Auth(), extractToken() (+23 more)

### Community 243 - "Community 243"
Cohesion: 0.08
Nodes (28): Client, Hub, authenticateToken(), checkOrigin(), firstMessageAuth(), HandleWebSocket(), init(), loadAllowedOrigins() (+20 more)
...
Cohesion: 0.13
Nodes (27): commentToResponse(), shouldInheritParentMentions(), CommentResponse, CreateCommentRequest, issueNoAssignee(), issueWithAgentAssignee(), TestCommentMentionsOthersButNotAssignee(), TestCommentMentionsOthersButNotAssignee_NoAssignee() (+19 more)
...
Cohesion: 0.08
Nodes (25): shell, collapse_sidebar, empty_project_subtitle, empty_project_title, empty_subtitle, empty_title, expand_sidebar, new_session (+17 more)

### Community 263 - "Community 263"
Cohesion: 0.05
Nodes (78): isAgentActivityTask(), isDesignStudioTask(), isDevStudioTask(), taskStatusConfig, agentTasksOptions(), useWorkspaceActivityMap(), AgentLiveCard(), AgentLiveCardProps (+70 more)
...
Cohesion: 0.09
Nodes (33): Markdown(), ChatBubbleProps, ChatContent(), DesignQuestionsPanel(), answerDisplay(), buildInitialState(), canonicalizeValue(), QuestionFormView() (+25 more)
...
Cohesion: 0.23
Nodes (20): boundedBuffer, isSoftNotFound(), RequestLogger(), requireLogLevel(), runRequestLogger(), TestIsSoftNotFound(), TestRequestLogger_200StaysInfo(), TestRequestLogger_400StaysWarn() (+12 more)
...
Cohesion: 0.08
Nodes (43): AttachmentDownloadContext, AttachmentDownloadProvider(), ProviderProps, ResolvedDownload, useAttachmentDownloadResolver(), AttachmentPreviewHandle, AttachmentPreviewModal(), AttachmentPreviewModalProps (+35 more)
...
Cohesion: 0.24
Nodes (13): CreateDevSessionRequest, devSessionFromCreatorListRow(), devSessionFromListRow(), devSessionFromRow(), DevSessionResponse, ListDevChatSessionsByCreatorRow, ListDevChatSessionsByProjectRow, ChatSession (+5 more)

### Community 394 - "Community 394"
Cohesion: 0.22
Nodes (13): ActivityHeatmap(), DAY_LABELS, fmtDate(), fmtMoney(), getHeatmapColor(), Insight(), Insights, InsightsRow() (+5 more)
...
Cohesion: 0.22
Nodes (12): CreateDevChatSessionParams, ListDevChatSessionsByCreatorParams, ListDevChatSessionsByCreatorRow, ListDevChatSessionsByProjectParams, ListDevChatSessionsByProjectRow, SetWorkspaceDefaultDevAgentParams, ChatSession, Context (+4 more)
...
Cohesion: 0.04
Nodes (57): attachment, close, download_failed, preview, preview_failed, preview_loading, preview_too_large, preview_unsupported (+49 more)
...
Cohesion: 0.10
Nodes (42): IssuesUrlSync(), Page(), ActorIssuesScope, ActorIssuesViewState, actorIssuesViewStore, basePersist, useCommentCollapseStore, CommentDraftKey (+34 more)
...
Cohesion: 0.21
Nodes (14): AgentTaskQueue, ChatSession, Context, Issue, T, UUID, dbScopeAuthorizer, fakeScopeQuerier (+6 more)
...
Cohesion: 0.05
Nodes (68): getApi(), setApiInstance(), setSchemaLogger(), registerAuthStore(), registerChatStore(), EMPTY_DRAFT, FeedbackDraft, FeedbackDraftStore (+60 more)
...
Cohesion: 0.07
Nodes (36): handleCopilotEvent(), withCopilotExitCode(), copilotAssistantMessage, copilotBackend, copilotCodeChanges, copilotEvent, copilotEventState, copilotMessageDelta (+28 more)
...
Cohesion: 0.09
Nodes (23): help, changelog, docs, feedback, trigger, sidebar, configure_group, create_workspace (+15 more)
...
Cohesion: 0.20
Nodes (13): ClientMetadata(), ClientMetadataFromContext(), SetClientMetadata(), TestClientMetadataExtractsHeaders(), TestClientMetadataMissingHeadersReturnEmpty(), TestSetClientMetadataAttachesValues(), clientMetadataKey, Handler (+5 more)
...
Cohesion: 0.35
Nodes (8): localFirstPublisher, attachRealtimeTestClient(), TestDualWriteBroadcasterFansOutLocallyBeforePublishing(), TestNewRedisRelayWithClientsSeparatesBlockingReadPool(), TestRedisRelayStopPreventsNewConsumers(), Client, Hub, T
...
Cohesion: 0.14
Nodes (19): parseRuntimeIDs(), DaemonAuth(), DaemonAuthPathFromContext(), DaemonIDFromContext(), DaemonWorkspaceIDFromContext(), TestDaemonAuth_DaemonTokenCacheHit(), TestDaemonAuth_InvalidMDT_NilQueries(), TestDaemonAuth_MissingAuth() (+11 more)
...
Cohesion: 0.11
Nodes (32): ContextBadge(), DaemonPanel(), DaemonPanelProps, DisplayItem, EmptyState(), FilterChip(), GroupRows(), highlight() (+24 more)
...
Cohesion: 0.20
Nodes (9): after, before, byModel, cost, fictional, rows, sonnet, store (+1 more)
...
Cohesion: 0.05
Nodes (45): chip, fallback_label, delete_dialog, cancel, confirm, description, title, page (+37 more)
...
Cohesion: 0.08
Nodes (32): compositeMarkImage(), DesignMarkOverlay(), NormalizedRect, Point, Stroke, MarkAnnotationAction, MarkSubTool, bridgeScript() (+24 more)
...
Cohesion: 0.13
Nodes (14): listDir(), NewBrowser(), TestBrowserReadIndexHTML(), writeFile(), Browser, ResolveUnderRoot(), TestResolveUnderRoot(), ArtifactListEntry (+6 more)
...
Cohesion: 0.08
Nodes (31): FeatureArtifactBrowse(), FeatureArtifactServing(), FeatureIssuePreview(), envDefaultTrue(), FeatureDesignExport(), FeatureDesignJury(), FeatureDesignStudio(), PluginEntry (+23 more)
...
Cohesion: 0.43
Nodes (5): ensureWorkdirAccessible(), normalizeWorkdirPath(), TestEnsureWorkdirAccessible(), TestNormalizeWorkdirPath(), T
...
Cohesion: 0.22
Nodes (8): NavigationProgress(), AppLinkProps, NavigationContext, NavigationPendingContext, NavigationProvider(), useIsNavigating(), NavigationAdapter, NavigationProviderInner()
...
Cohesion: 0.60
Nodes (4): TestShardedStreamRelayConfigDefaults(), TestShardedStreamRelayDeliverMessageUsesEnvelopeScope(), TestShardedStreamRelayShardForScopeIsStableAndBounded(), T
...
Cohesion: 0.40
Nodes (5): Agent Triggers, Assign Issue, Autopilots, Direct Chat, @mention Agent
...
Cohesion: 0.27
Nodes (11): testCmd(), TestLoginTokenFlagParsing(), TestLoginTokenFlagWiring(), TestNormalizeAPIBaseURL(), TestResolveAppURL(), TestResolveCallbackBinding(), setTestHome(), TestRunSkillGenerate() (+3 more)
...
Cohesion: 0.13
Nodes (14): 1. AICortex 是什么, 2. 核心概念词典, 5. 产品地图（全部路由）, AICortex 产品全景文档, 一句话定位, 公共 / 认证, 定位一句话版本, 尾声 (+6 more)
...
Cohesion: 0.33
Nodes (4): Context, Pool, sweepInactiveRuntimeTunnels(), FeatureRuntimeTunnel()
...
Cohesion: 0.14
Nodes (18): DesignHtmlPreview(), PreviewCommentHandler, useStageOverlayBounds(), buildTunnelPreviewURL(), formatPreviewAddressLabel(), useDesignPreviewSource(), DEFAULT_TAB_ORDER, DesignToolsSidebar() (+10 more)
...
Cohesion: 0.50
Nodes (3): tools, unavailable_explore, unavailable_no_runtime
...
Cohesion: 0.25
Nodes (14): buildTunnelPreviewURL(), ChatWebPanel(), WebPreviewMode, DesignPreviewSourcePanel(), ModeToggle(), buildTunnelPreviewURL(), RuntimeTunnelPanel(), useRuntimeTunnelFeature() (+6 more)
...
## Knowledge Gaps
- **20832 isolated node(s):** `type`, `url`, `directory`, `name`, `email` (+20827 more)
...
- **Why does `loadFromFS()` connect `Community 404` to `Community 1648`, `OpenClaw Runtime Args`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `readFile()` connect `OpenClaw Runtime Args` to `Community 768`, `Community 522`, `Community 523`, `Agent Query Key Factories`, `Community 404`, `Community 1684`, `Community 149`, `Community 150`, `Community 28`, `Community 30`, `Community 43`, `Community 304`, `Community 565`, `Community 64`, `Community 66`, `Community 67`, `Community 214`, `Community 1239`, `Community 1756`, `Community 478`, `Community 1247`, `Community 224`, `Community 97`, `Community 492`, `Community 625`, `Community 508`, `Community 381`?**
...
- **What connects `type`, `url`, `directory` to the rest of the system?**
  _20839 weakly-connected nodes found - possible documentation gaps or missing edges._
