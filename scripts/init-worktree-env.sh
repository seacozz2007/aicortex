...
postgres_db="aicortex_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://aicortex:aicortex@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
AICORTEX_DEV_VERIFICATION_CODE=888888
AICORTEX_SERVER_URL=ws://localhost:${backend_port}/ws
