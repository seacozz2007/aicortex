...
var rootHelpTemplate = `Work seamlessly with AICortex from the command line.

USAGE
  aicortex <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ aicortex agent list --output json

ENVIRONMENT VARIABLES
  AICORTEX_SERVER_URL    Override the default server URL
  AICORTEX_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`aicortex <command> <subcommand> --help`" + ` for more information about a command.
`
