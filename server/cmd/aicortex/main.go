...
var rootCmd = &cobra.Command{
	Use:   "aicortex",
	Short: "AICortex CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with AICortex from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.SetVersionTemplate("aicortex {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "AICortex server URL (env: AICORTEX_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: AICORTEX_WORKSPACE_ID)")
