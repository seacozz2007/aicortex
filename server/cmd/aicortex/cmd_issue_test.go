...
// aicortex/aicortex#1620: when one name is a substring of another (e.g.
...
// aicortex/aicortex#1620: passing a full UUID or its 8-char prefix must
...
// `aicortex issue subscriber add --user "<SquadName>"` or
// `aicortex project create --lead "<SquadName>"` would resolve to
