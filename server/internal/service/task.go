...
// `aicortex issue create` call. Pre-validates that the agent is reachable
...
// manual `aicortex agent update <id> --status idle` to unwedge. Matches the
...
// daemon-injected AICORTEX_QUICK_CREATE_TASK_ID env var, so this lookup is
