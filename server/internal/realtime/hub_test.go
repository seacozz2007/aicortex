...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"empty origin allowed", "api.aicortex.ai", "", true},
		{"same-origin allowed (native client default)", "localhost:8080", "http://localhost:8080", true},
		{"same-origin allowed (https)", "api.aicortex.ai", "https://api.aicortex.ai", true},
		{"same-origin allowed (case-insensitive host, RFC 7230)", "API.AICortex.AI", "https://api.aicortex.ai", true},
		{"whitelisted origin allowed (web cross-origin)", "localhost:8080", "http://localhost:3000", true},
		{"whitelisted origin allowed (prod web)", "api.aicortex.ai", "https://aicortex.ai", true},
		{"unknown origin rejected (CSWSH defense)", "api.aicortex.ai", "https://evil.com", false},
