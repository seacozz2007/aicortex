...
type AgentTaskResponse struct {
	...
	ChatMessageAttachments  []ChatAttachmentMeta  `json:"chat_message_attachments,omitempty"`  // attachments on the user message — agent calls `aicortex attachment download <id>` per entry
...
// `aicortex attachment download <id>` rather than guessing from the
