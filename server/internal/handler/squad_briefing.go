...
2. **Delegate by @mention.** Post a single comment on this issue that
   ...
   - **Be terse.** Every AICortex agent already has full context of the
...
3. **Record your evaluation.** After every trigger — whether you delegated,
   ...
   ` + "`" + `aicortex squad activity <issue-id> <outcome> --reason "<short reason>"` + "`" + `
...
- ALWAYS call ` + "`" + `aicortex squad activity` + "`" + ` before ending your turn —
