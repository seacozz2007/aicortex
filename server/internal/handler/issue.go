...
import (
	...
	"github.com/aicortex/aicortex/server/internal/issueguard"
...
// translates the prompt into a `aicortex issue create` invocation in the
...
// the agent's `aicortex issue create` invocation passes `--project <uuid>`
...
// metadata column is JSONB on the wire; the daemon stores the aicortex CLI
...
func (h *Handler) BatchUpdateIssues(w http.ResponseWriter, r *http.Request) {
	...
	// count match reality. See aicortex/aicortex#1660.
