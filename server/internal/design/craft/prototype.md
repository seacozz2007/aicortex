...
- Ship working HTML/CSS in the work directory — not mockups in chat.
- Use semantic HTML5 landmarks (`header`, `main`, `nav`, `section`, `footer`).
- Prefer CSS custom properties for colors and spacing tied to DESIGN.md tokens.
