...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.aicortex.ai"
	cookieDomain string // cookie scope, e.g. ".aicortex.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.aicortex.ai")
//   - COOKIE_DOMAIN           (e.g. ".aicortex.ai")
