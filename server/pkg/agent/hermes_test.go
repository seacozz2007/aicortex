...
// aicortex#1952 scenario: the upstream LLM returns HTTP 429 (rate
...
// fix for GitHub aicortex#1952: a hermes run that hits a 429 (or any
...
// regression GPT-Boy flagged on the aicortex#1952 fix: a per-attempt
