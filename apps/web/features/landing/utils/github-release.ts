...
/**
 * Server-side fetcher for the latest AICortex release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/aicortex/aicortex/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — AICortex doesn't publish prereleases or drafts
