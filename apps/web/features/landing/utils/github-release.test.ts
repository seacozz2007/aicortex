...
const SAMPLE_LATEST_ASSET = {
  name: "aicortex-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/aicortex/aicortex/releases/download/v0.2.14/aicortex-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "aicortex-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/aicortex/aicortex/releases/download/v0.2.13/aicortex-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/aicortex/aicortex/releases/tag/${overrides.tag}`,
