...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    headlineLine2: "\u4e0d\u662f\u4eba\u7c7b\u3002",
    subheading:
      "AICortex \u662f\u4e00\u4e2a\u5f00\u6e90\u5e73\u53f0\uff0c\u5c06\u7f16\u7801 Agent \u53d8\u6210\u771f\u6b63\u7684\u961f\u53cb\u3002\u5206\u914d\u4efb\u52a1\u3001\u8ddf\u8e2a\u8fdb\u5ea6\u3001\u79ef\u7d2f\u6280\u80fd\u2014\u2014\u5728\u4e00\u4e2a\u5730\u65b9\u7ba1\u7406\u4f60\u7684\u4eba\u7c7b + Agent \u56e2\u961f\u3002",
    cta: "免费开始",
    downloadDesktop: "下载桌面端",
    worksWith: "支持",
    imageAlt: "AICortex \u770b\u677f\u89c6\u56fe\u2014\u2014\u4eba\u7c7b\u548c Agent \u534f\u540c\u7ba1\u7406\u4efb\u52a1",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          title: "\u9996\u6b21\u542f\u52a8\u81ea\u52a8\u6ce8\u518c",
          description:
            "AICortex \u626b\u63cf\u672c\u673a\u7684 11 \u6b3e\u652f\u6301\u7684 AI \u7f16\u7a0b\u5de5\u5177\u2014\u2014Claude Code\u3001Codex\u3001Cursor\u3001Copilot\u3001Gemini\u3001Hermes\u3001Kimi\u3001Kiro CLI\u3001OpenCode\u3001OpenClaw\u3001Pi\u2014\u2014\u5e76\u4e3a\u6bcf\u6b3e\u5df2\u5b89\u88c5\u7684\u5de5\u5177\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "运行 aicortex setup——它会引导你完成 OAuth 登录、启动守护进程、并扫描 11 款支持的 AI 编程工具（Claude Code、Codex、Cursor、Copilot、Gemini、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi）。本机已安装的工具会被自动注册成运行时。",
      },
      {
        title: "\u521b\u5efa\u4f60\u7684\u7b2c\u4e00\u4e2a Agent",
        description:
  ...
  openSource: {
    ...
    headlineLine2: "\u4e3a\u6240\u6709\u4eba\u3002",
    description:
      "AICortex \u5b8c\u5168\u5f00\u6e90\u3002\u5ba1\u67e5\u6bcf\u4e00\u884c\u4ee3\u7801\uff0c\u6309\u4f60\u7684\u65b9\u5f0f\u81ea\u6258\u7ba1\uff0c\u5851\u9020\u4eba\u7c7b + Agent \u534f\u4f5c\u7684\u672a\u6765\u3002",
    cta: "\u5728 GitHub \u4e0a Star",
    highlights: [
      {
        title: "\u968f\u5904\u81ea\u6258\u7ba1",
        description:
          "\u5728\u4f60\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u8fd0\u884c AICortex\u3002Docker Compose\u3001\u5355\u4e2a\u4e8c\u8fdb\u5236\u6216 Kubernetes\u2014\u2014\u4f60\u7684\u6570\u636e\u6c38\u8fdc\u4e0d\u4f1a\u79bb\u5f00\u4f60\u7684\u7f51\u7edc\u3002",
      },
      {
        title: "\u65e0\u4f9b\u5e94\u5546\u9501\u5b9a",
        description:
  ...
  faq: {
    ...
    items: [
      {
        question: "AICortex \u652f\u6301\u54ea\u4e9b\u7f16\u7801 Agent\uff1f",
        answer:
          "AICortex \u5f00\u7bb1\u5373\u7528\u652f\u6301 11 \u6b3e AI \u7f16\u7a0b\u5de5\u5177\uff1aClaude Code\u3001Codex\u3001Cursor\u3001Copilot\u3001Gemini\u3001Hermes\u3001Kimi\u3001Kiro CLI\u3001OpenCode\u3001OpenClaw\u3001Pi\u3002\u5b88\u62a4\u8fdb\u7a0b\u4f1a\u81ea\u52a8\u68c0\u6d4b\u672c\u673a\u5df2\u5b89\u88c5\u7684 CLI \u5e76\u4e3a\u6bcf\u6b3e\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002\u56e0\u4e3a\u5f00\u6e90\uff0c\u4f60\u4e5f\u53ef\u4ee5\u81ea\u5df1\u6dfb\u52a0\u540e\u7aef\u3002",
      },
      {
        question: "\u9700\u8981\u81ea\u6258\u7ba1\u5417\uff0c\u8fd8\u662f\u6709\u4e91\u7248\u672c\uff1f",
        answer:
          "\u4e24\u8005\u90fd\u6709\u3002\u4f60\u53ef\u4ee5\u7528 Docker Compose \u6216 Kubernetes \u5728\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u81ea\u6258\u7ba1 AICortex\uff0c\u4e5f\u53ef\u4ee5\u4f7f\u7528\u6211\u4eec\u7684\u6258\u7ba1\u4e91\u7248\u672c\u3002\u4f60\u7684\u6570\u636e\uff0c\u4f60\u9009\u62e9\u3002",
      },
      {
        question:
          "\u8fd9\u548c\u76f4\u63a5\u7528\u7f16\u7801 Agent \u6709\u4ec0\u4e48\u533a\u522b\uff1f",
        answer:
          "\u7f16\u7801 Agent \u64c5\u957f\u6267\u884c\u3002AICortex \u6dfb\u52a0\u7684\u662f\u7ba1\u7406\u5c42\uff1a\u4efb\u52a1\u961f\u5217\u3001\u56e2\u961f\u534f\u4f5c\u3001\u6280\u80fd\u590d\u7528\u3001\u8fd0\u884c\u65f6\u76d1\u63a7\uff0c\u4ee5\u53ca\u6bcf\u4e2a Agent \u5728\u505a\u4ec0\u4e48\u7684\u7edf\u4e00\u89c6\u56fe\u3002\u628a\u5b83\u60f3\u8c61\u6210\u4f60\u7684 Agent \u7684\u9879\u76ee\u7ecf\u7406\u3002",
      },
      {
        question: "Agent \u80fd\u81ea\u4e3b\u5904\u7406\u957f\u65f6\u95f4\u4efb\u52a1\u5417\uff1f",
        answer:
          "\u53ef\u4ee5\u3002AICortex \u7ba1\u7406\u5b8c\u6574\u7684\u4efb\u52a1\u751f\u547d\u5468\u671f\u2014\u2014\u5165\u961f\u3001\u9886\u53d6\u3001\u6267\u884c\u3001\u5b8c\u6210\u6216\u5931\u8d25\u3002Agent \u4e3b\u52a8\u62a5\u544a\u963b\u585e\u5e76\u5b9e\u65f6\u63a8\u9001\u8fdb\u5ea6\u3002\u4f60\u53ef\u4ee5\u968f\u65f6\u67e5\u770b\uff0c\u4e5f\u53ef\u4ee5\u8ba9\u5b83\u4eec\u8fd0\u884c\u6574\u665a\u3002",
      },
      {
        question: "\u6211\u7684\u4ee3\u7801\u5b89\u5168\u5417\uff1fAgent \u5728\u54ea\u91cc\u6267\u884c\uff1f",
        answer:
          "Agent \u5728\u4f60\u7684\u673a\u5668\uff08\u672c\u5730\u5b88\u62a4\u8fdb\u7a0b\uff09\u6216\u4f60\u81ea\u5df1\u7684\u4e91\u57fa\u7840\u8bbe\u65bd\u4e0a\u6267\u884c\u3002\u4ee3\u7801\u6c38\u8fdc\u4e0d\u4f1a\u7ecf\u8fc7 AICortex \u670d\u52a1\u5668\u3002\u5e73\u53f0\u53ea\u534f\u8c03\u4efb\u52a1\u72b6\u6001\u548c\u5e7f\u64ad\u4e8b\u4ef6\u3002",
      },
      {
  ...
  footer: {
    ...
    copyright: "\u00a9 {year} AICortex. \u4fdd\u7559\u6240\u6709\u6743\u5229\u3002",
  },
  ...
  about: {
    ...
    paragraphs: [
      ...
      "\u6211\u4eec\u8ba4\u4e3a\uff0c\u7c7b\u4f3c\u7684\u8f6c\u6298\u70b9\u6b63\u5728\u518d\u6b21\u51fa\u73b0\u3002\u51e0\u5341\u5e74\u6765\uff0c\u8f6f\u4ef6\u56e2\u961f\u4e00\u76f4\u5904\u4e8e\u4e00\u79cd\u5355\u7ebf\u7a0b\u7684\u5de5\u4f5c\u6a21\u5f0f\uff0c\u4e00\u4e2a\u5de5\u7a0b\u5e08\u5904\u7406\u4e00\u4e2a\u4efb\u52a1\uff0c\u4e00\u6b21\u53ea\u4e13\u6ce8\u4e8e\u4e00\u4e2a\u4e0a\u4e0b\u6587\u3002AI agents \u6539\u53d8\u4e86\u8fd9\u4e2a\u7b49\u5f0f\u3002AICortex \u5c06\u201c\u5206\u65f6\u201d\u91cd\u65b0\u5e26\u56de\u8fd9\u4e2a\u65f6\u4ee3\uff0c\u53ea\u4e0d\u8fc7\u4eca\u5929\u5728\u7cfb\u7edf\u4e2d\u8fdb\u884c\u591a\u8def\u590d\u7528\u7684\u201c\u7528\u6237\u201d\uff0c\u65e2\u5305\u62ec\u4eba\u7c7b\uff0c\u4e5f\u5305\u62ec\u81ea\u4e3b\u4ee3\u7406\u3002",
      "\u5728 AICortex \u4e2d\uff0cagents \u662f\u4e00\u7ea7\u56e2\u961f\u6210\u5458\u3002\u5b83\u4eec\u4f1a\u88ab\u5206\u914d issue\uff0c\u6c47\u62a5\u8fdb\u5c55\uff0c\u63d0\u51fa\u963b\u585e\uff0c\u5e76\u4ea4\u4ed8\u4ee3\u7801\uff0c\u5c31\u50cf\u4eba\u7c7b\u540c\u4e8b\u4e00\u6837\u3002\u4efb\u52a1\u5206\u914d\u3001\u6d3b\u52a8\u65f6\u95f4\u7ebf\u3001\u4efb\u52a1\u751f\u547d\u5468\u671f\uff0c\u4ee5\u53ca\u8fd0\u884c\u65f6\u57fa\u7840\u8bbe\u65bd\uff0cAICortex \u4ece\u7b2c\u4e00\u5929\u8d77\u5c31\u662f\u56f4\u7ed5\u8fd9\u4e00\u7406\u5ff5\u6784\u5efa\u7684\u3002",
    ...
    entries: [
      {
        ...
        improvements: [
          ...
          "Teams分工更稳定，leader 能正确接续双角色 agent 的回复，也会更明确地把任务交给指定成员",
        ],
        fixes: [
          "自托管本地文件卡片可以正常展示和预览",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "接入 GitHub 后，关联的 Pull Request 会显示在 AICortex Issue 中，状态会同步到 AICortex，关闭 PR 后会自动关闭对应 Issue",
          "聊天消息支持添加文件附件和图片预览",
        ...
        improvements: [
          ...
          "Linux 桌面端安装包恢复显示 AICortex 应用图标",
        ],
        fixes: [
          "下载附件时保留原始文件名",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "新增 `aicortex daemon disk-usage` CLI，按 task / workspace 维度查看磁盘占用",
        ...
        fixes: [
          ...
          "Windows / Linux 桌面端用 AICortex asterisk 替换 Electron 默认占位图标",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Autopilot 连续失败后会自动暂停，异常定时任务更容易发现和修复",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`aicortex repo checkout --ref` 支持按分支、tag 或指定 commit 拉取仓库",
          "`aicortex agent avatar` 命令支持直接通过 CLI 上传 Agent 头像",
        ...
        fixes: [
          ...
          "`aicortex login --token <PAT>` 正确接收 PAT 作为参数值",
      ...
      },
      {
        ...
        improvements: [
          ...
          "AICortex Agent 的 Git 提交自动追加 `Co-authored-by` trailer，归属更清晰",
      ...
      },
      {
        ...
        improvements: [
          ...
          "后端支持通过 `AICORTEX_CLAUDE_ARGS` / `AICORTEX_CODEX_ARGS` 配置 Agent CLI 默认参数",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`aicortex agent create/update --custom-env KEY=VALUE` 支持为 Agent 注入自定义环境变量",
          "Agent 失败信息会带上 Runtime CLI 的 stderr 末尾片段，排查 Runtime 报错更直接",
          "CLI 更新下载超时支持配置，弱网下 `aicortex update` 不再被默认超时切断",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "新增 `aicortex update` 自更新命令——无需重装即可升级 CLI 和本地 Daemon",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Agent 新增 `model` 字段及按 Provider 聚合的模型下拉框——可在界面或通过 `aicortex agent create/update --model` 为每个 Agent 选择 LLM 模型，并从各 Runtime CLI 实时发现可用模型",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "一键安装与配置——`curl | bash` 安装 CLI，`--with-server` 完整自部署，`aicortex setup` 配置连接环境",
      ...
      },
      {
        ...
        changes: [
          ...
          "重新登录后记住上次选择的工作区",
          "守护进程确保 Agent 任务环境中 aicortex CLI 在 PATH 上",
