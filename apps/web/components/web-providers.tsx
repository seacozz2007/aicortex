...
import { createBrowserCookieLocaleAdapter } from "@aicortex/core/i18n/browser";
...
// cookie mode on their next logout/login cycle (logout clears aicortex_token).
// Sunset: once telemetry shows <1% of sessions still carry aicortex_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("aicortex_token"));
  } catch {
    return false;
  }
}
