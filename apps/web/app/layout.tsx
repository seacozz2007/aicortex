...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.aicortex.ai"),
  title: {
    default: "AICortex — Project Management for Human + Agent Teams",
    template: "%s | AICortex",
  },
  description:
...
export default async function RootLayout({
  ...
  const headerLocale = h.get("x-aicortex-locale");
