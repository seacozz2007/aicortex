...
export const metadata: Metadata = {
  title: "Download AICortex",
  description:
    "Download AICortex for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download AICortex",
    description:
      "Get the AICortex desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
