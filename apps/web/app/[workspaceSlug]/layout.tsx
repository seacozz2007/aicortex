...
import { WorkspaceSlugProvider, paths } from "@aicortex/core/paths";
import { workspaceBySlugOptions } from "@aicortex/core/workspace";
import { setCurrentWorkspace } from "@aicortex/core/platform";
import { useAuthStore } from "@aicortex/core/auth";
import { NoAccessPage } from "@aicortex/views/workspace/no-access-page";
import { AICortexIcon } from "@aicortex/ui/components/common/aicortex-icon";
import { useWorkspaceSeen } from "@aicortex/views/workspace/use-workspace-seen";
