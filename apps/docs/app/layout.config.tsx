...
// Docs-local stateless AICortex mark — matches @aicortex/ui's AICortexIcon
...
// packages/ui/components/common/aicortex-icon.tsx if the mark changes.
const AICORTEX_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / AICortex asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">AICortex Docs</span>
    ),
  },
  links: [
    {
      ...
      url: "https://github.com/aicortex/aicortex",
      external: true,
    },
    {
      icon: <AICortexMark />,
      text: externalLinkText("AICortex"),
      url: "https://aicortex.ai",
      external: true,
    },
  ],
};
