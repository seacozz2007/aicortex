---
title: Contributing
description: Local development workflow for contributors working on the AICortex codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `aicortex` | `aicortex_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U aicortex -d postgres \
