---
title: Architecture
description: Technical architecture of the AICortex platform.
---

## Overview

AICortex is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `aicortex` (CLI + daemon), `migrate`
