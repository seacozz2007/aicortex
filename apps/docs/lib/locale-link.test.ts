...
describe("prefixLocale", () => {
  ...
  it("leaves external URLs alone", () => {
    expect(prefixLocale("https://aicortex.ai/download", "zh")).toBe(
      "https://aicortex.ai/download",
    );
    expect(prefixLocale("mailto:hello@aicortex.ai", "zh")).toBe(
      "mailto:hello@aicortex.ai",
    );
