...
import { ProjectsPage } from "@aicortex/views/projects/components";
import { DashboardPage } from "@aicortex/views/dashboard";
import { AutopilotsPage } from "@aicortex/views/autopilots/components";
import { MyIssuesPage } from "@aicortex/views/my-issues";
import { SkillsPage } from "@aicortex/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@aicortex/views/agents";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@aicortex/views/squads/components";
import { InboxPage } from "@aicortex/views/inbox";
import { SettingsPage } from "@aicortex/views/settings";
