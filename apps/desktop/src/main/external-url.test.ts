...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://aicortex.ai")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://aicortex.ai");
    expect(shell.openExternal).toHaveBeenCalledWith("https://aicortex.ai");
  });
