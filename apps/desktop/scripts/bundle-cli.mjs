#!/usr/bin/env node
// Builds the `aicortex` CLI from server/cmd/aicortex and copies the binary
...
//
// ldflags mirror `make build` so `aicortex --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "aicortex.exe" : "aicortex";
}
